...
if (_weapon in ["M1Gun_x200","M12Gun_x200","LeoGun_x200","Gun120"]) then {_booleShell = true; _sizeOfShell = 120};
if (_weapon in ["T80Gun_x200","T90Gun_x200","PLAGun_x200","Gun125", "Sprut_2A75_x200"]) then {_booleShell = true; _sizeOfShell = 125};
if (_weapon in ["Gun130_x200"]) then {_booleShell = true; _sizeOfShell = 130};
if (_weapon in ["Gun155_x200","PLA155Gun_x200"]) then {_booleShell = true; _sizeOfShell = 155};
...
if (!isNull _effectShell) then {
	// SLX MG Hit Effect
	_type = typeOf _shell;
	if ( _type in ["CoaxW_x200","CoaxE_x200","50calW_x200","50calE_x200","Bullet7_6","Bullet12_7"] ) then {
	...
	if ( _weapon in ["MachineGun30","MachineGun30W","M197_x200","VulcanCannon_x200","Cannon_20HE_x200","Cannon_20AP_x200","RMKHETiger_DVD_x200","RMKAPTiger_DVD_x200",  "MachineGun30E","ZsuCannon","Cannon30_Kamov_x200","CannonE_20HE_x200","CannonE_20AP_x200",  "MachineGun30A10","MachineGun30A10Burst","RKTHunter_Guns","Cannon_Heli_x200","Cannon_30APHE_x200"] ) then {
