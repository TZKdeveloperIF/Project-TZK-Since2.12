...
class CfgVehicles {
	...
	class Logic_T72_xj400: Logic_xj400 {
		model = "t72";
	};
	class Logic_Jeep_xj400: Logic_xj400 {
		model = "jeep";
	};
	class Logic_HMMWV_xj400: Logic_xj400 {
		model = "\humr\HMMWV.p3d";
	};
	class Logic_Truck5t_xj400: Logic_xj400 {
		model = "truck5t";
	};
	class Logic_Truck5tRepair_xj400: Logic_xj400 {
		model = "truck5trepair";
	};
	class Logic_Truck5tRefuel_xj400: Logic_xj400 {
		model = "truck5tfuel";
	};
	...
	class Logic_BRDM_xj400: Logic_xj400 {
		model = "\brmd\brmd.p3d";
	};
	class Logic_Ural_xj400: Logic_xj400 {
		model = "ural";
	};
	class Logic_UralRepair_xj400: Logic_xj400 {
		model = "uralrepair";
	};
	class Logic_UralRefuel_xj400: Logic_xj400 {
		model = "uralfuel";
	};
	class Logic_BMP_xj400: Logic_xj400 {
		model = "bmp";
	};
	class Logic_BMPAmbu_xj400: Logic_xj400 {
		model = "bmp_Ambu";
	};
