private ["_idcTransferAmount", "_idcIncomeRatio", "_idcIncomeRatioPlayer", "_idcReports", "_idcTransferCommandGroup", "_idcWorkerBehaviour", "_idcAIRespawn",
...
_incomeRatio = incomeRateCo select siPlayer; _incomeRatioPlayer = incomeRatePlayer select siPlayer;
...
lbSetCurSel [_idcWorkerBehaviour, workerBehaviour select siPlayer];

_respawnObject = sideRespawnObjects select siPlayer;
