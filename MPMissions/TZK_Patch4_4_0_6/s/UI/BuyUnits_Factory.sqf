comment {args: none};
comment {read variables external};
comment {read-only var: _idcFactory, _typeFactory, _typeFactoryLast};
comment {write-only var: _factoryCache, _factories};
...
comment {[_factories, _factoryIndex]};