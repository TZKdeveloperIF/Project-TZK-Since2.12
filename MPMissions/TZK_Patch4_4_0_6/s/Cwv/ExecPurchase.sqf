...
_k = 0; _c = count _shoppingCartMag; while {_k < _c} do {
	...
	[_magInfo select _infoIdx select _piName, _si, _enum, _vehicle] call preprocessFile "\TZK_Patch4_4_0_6\s\Cwv\ProperMagWep.sqf";
...
_m = []; _w = [];
_vehicle call preprocessFile "\TZK_Patch4_4_0_6\s\Cwv\AppendGeneralEquips.sqf";
