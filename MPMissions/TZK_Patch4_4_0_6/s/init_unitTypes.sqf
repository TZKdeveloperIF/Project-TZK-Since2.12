...
unitDefs set [_type, ["Support Carrier", 500, _si, 10, "SoldierWSupport_xj400", "imedic", 2^_st, [], "", ["Common\Init\SoldierSupportCarrier.sqs"]] ];
...
comment {Since TZK_4.0.6 units are listed first by type then by factory} ;
...
unitDefs set [_type, ["Patrol Boat Sup", 1200, _si, 30, "GunBoatW_xj400", "ipbr", 2^stLight + 2^stShip, [2, _crewW], _mSupport, ["Common\InitSupportVehicle.sqs","Common\Equip\BoatWmg.sqs"]] ];
_boatsupW = _type;
_type = _type + 1;
...
unitDefs set [_type, ["LST", 10000, _si, 60, "LST_W_xj400", "\tzk_texture_4_0_6\ui\iLst.paa", -1, [1, _crewW], _mLst, []] ];
_lstW = _type;
_type = _type + 1;
...
unitDefs set [_type, ["M88 (ARV)", _costSupportAPC, _si, 30, "M88arv_mfm_xj400", "\tzk_texture_4_0_6\m88\m88pic.paa", 2^stHeavy + 2^stLight, [2, _crewW], _mEngineerVeh, ["Common\InitEngineerVeh.sqs"]] ];
_m88W = _type;
_type = _type + 1;
...
unitDefs set [_type, ["M2A2 FFAR", 3500, _si, 30, "M2A2_AA_xj400", "\M2A2\im2a2", 2^_st, [3, _crewW], _mAPC, ["Common\Equip\M2A2farr.sqs"]] ];
_m2a2d = _type;
_type = _type + 1;
...
unitDefs set [_type, ["M109A6-G", 7500, _si, 60, "M109A6G_xj400", "\TZK_Texture_4_0_0\icon\iM109A6G.paa", 2^_st, [2, _crewW], _mHowitzer, ["Common\Equip\Art155.sqs"]] ];
_m109W = _type;
_type = _type + 1;
...
unitDefs set [_type, ["M270 MLRS", 25000, _si, 60, "M270_M29064_xj400", "\TZK_Texture_4_0_0\icon\iM270.paa", 2^_st, [2, _crewW], _mMLRS, ["Common\Equip\ArtMLRS.sqs"]] ];
_m270W = _type;
_type = _type + 1;
...
unitDefs set [_type, ["Support Carrier", 500, _si, 10, "SoldierESupport_xj400", "imedic", 2^_st, [], "", ["Common\Init\SoldierSupportCarrier.sqs"]] ];
...
unitDefs set [_type, ["Patrol Boat Sup", 1200, _si, 30, "GunBoatE_xj400", "ipbr", 2^stLight + 2^stShip, [2, _crewE], _mSupport, ["Common\InitSupportVehicle.sqs","Common\Equip\BoatEmg.sqs"]] ];
_boatsupE = _type;
_type = _type + 1;
...
unitDefs set [_type, ["LST", 10000, _si, 60, "LST_E_xj400", "\tzk_texture_4_0_6\ui\iLst.paa", -1, [1, _crewW], _mLst, []] ];
_lstE = _type;
_type = _type + 1;
...
unitDefs set [_type, ["BREM-1", _costSupportAPC, _si, 30, "BREM_mfm_xj400", "\tzk_texture_4_0_6\brem1\pic_brem1.paa", 2^stHeavy + 2^stLight, [2, _crewE], _mEngineerVeh, ["Common\InitEngineerVeh.sqs"]] ];
_bremE = _type;
_type = _type + 1;
...
unitDefs set [_type, ["BMP2 Rocket", 3500, _si, 30, "BMP2_AA_xj400", "ibmp", 2^_st, [3, _crewE], _mAPC, ["Common\Equip\BMP2farr.sqs"]] ];
_bmp2d = _type;
_type = _type + 1;
...
unitDefs set [_type, ["PLZ-89", 3750, _si, 40, "PLZ89_TZK_xj400", "\tzk_texture_4_0_6\ui\iPlz89.paa", 2^stHeavy + 2^stLight, [2, _crewE], _mHowitzer, []] ];
_plz89E = _type;
_type = _type + 1;

unitDefs set [_type, ["PLZ-05", 7500, _si, 60, "PLZ05_TZK_xj400", "\TZK_Texture_4_0_0\icon\iPLZ05.paa", 2^_st, [2, _crewE], _mHowitzer, ["Common\Equip\Art155.sqs"]] ];
_plz05E = _type;
_type = _type + 1;
...
unitDefs set [_type, ["TOS-1 Buratino", 25000, _si, 60, "TOS1_TZK_xj400", "\TZK_Texture_4_0_0\icon\iTOS_1.paa", 2^_st, [2, _crewE], _mMLRS, ["Common\Equip\ArtMLRS.sqs"]] ];
_tos1E = _type;
_type = _type + 1;
...
comment {global variables here are for AICO auto-buy} ;
...
comment {Define transport heli type for AICO. AI can't fly small heli well so only buy big heli} ;
...
typesPlane =[
	_c130supportW, _a10gun, _a10LGB4, _a10bombs, _a10, _a10FFAR, _a10LGB8, _a10AA, _a10BB, _a10Tomahawk,
	_an72supportE, _su25gun, _su25LGB4, _su25bombs, _su25, _su25Rocket, _su25LGB8, _su25AA, _su25BB, _su25Raduga, _c130W, _an72E,
	_B2, _su39
];
typesGunPlane = [_a10gun, _su25gun];
typesInfantryAll = [
	_soldierW1, _sniperW, _MortarW, _bomberW, _minerW, _crewW, _pilotW, 
	_soldierW3,_soldierW4,_rkgSoldierW,_mgW1,_mgW2,_mgW3,_mgW4,_sniperW,_heavySniperW,_lawSoldierW,_atW1,_atW2,_atW3,_atW4,_soldierAAW,_aaCommandoW,_laserW,_crewAAW,_vestW,_supportCarrierW,
	_soldierE1, _sniperE, _MortarE, _bomberE, _minerE, _crewE, _pilotE,
	_soldierE3,_soldierE4,_rkgSoldierE,_mgE1,_mgE2,_mgE3,_mgE4,_sniperE,_heavySniperE,_rpgSoldierE,_atE1,_atE2,_atE3,_atE4,_soldierAAE,_aaCommandoE,_laserE,_crewAAE,_vestE,_supportCarrierE
];
typesInfantryAT = [_lawSoldierW,_atW1,_atW2,_atW3,_atW4,_soldierAAW,_aaCommandoW, _rpgSoldierE,_atE1,_atE2,_atE3,_atE4,_soldierAAE,_aaCommandoE];
...
comment {definition for RTS reclaim} ;
...
comment {definition for RTS attach} ;
typesHeliTugger = [
...
comment {definition for crew/pilot} ;
typesCrew = [_crewW, _crewAAW, _pilotW, _crewE, _crewAAE, _pilotE];
comment {Engineer vehicles} ;
...
comment {implement in mission folder for appending and modifying} ;
call preprocessFile "impl\Unit.sqf";


comment {Define final global varialbes AFTER HAVING CALLED "impl\Unit.sqf"} ;
maxUnitTypes = count unitDefs; TotalUnitTypes = maxUnitTypes + countInfCustom;
unitTypeArray = []; unitTypeData = [];
_type = 0; _j = 0;
{
