comment {args: [auto buy types, auto buy nums, slots]};
comment {return: [[type, count, driver, gunner], ...]};
...
comment {check auto buy num first};
...
comment {generate a type randomly};
