private ["_Fired_EH_Array", "_vehicle", "_weapon", "_muzzle", "_mode", "_ammo", "_limitWeaponRangeFactor", "_shell", "_position", "_x", "_y", "_z", "_velocity", "_dir", "_effectShell", "_booleShell", "_sizeOfShell"];
...
_booleShell = false; _sizeOfShell = 0;
	...
	if (_weapon in ["Gun105_xj400"]) then {_booleShell = true; _sizeOfShell = 105};
