...
_text = "Beyond Map";
if (_iXbig >= 0 && _iXbig < 20 && _iXsmall >= 0 && _iYbig >= 0 && _iYbig < 20 && _iYsmall >= 0) then {
	_text = format["%1%2%3%4", _Xbig select _iXbig, _Xsmall select _iXsmall, _Ybig select _iYbig, _Ysmall select _iYsmall]
};
_text