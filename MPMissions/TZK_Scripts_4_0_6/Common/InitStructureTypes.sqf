...
structDefs set [_type, [
	...
	[localize {TZK_SERVER_INIT_STRUCT_SEC},  "\TZK_Scripts_4_0_4\Server\InitFuelStation.sqs"],
	[localize {TZK_MARKER_STRUCT}]]
];
...
structDefs set [_type, [
	"Roof", _price, siBoth, _image, true, false, 30, 1, 20, _objects, _objects,
	[localize {TZK_SERVER_INIT_STRUCT_SEC}], []]
];
structMarker set [_type, ""];
_roof = _type;
...
_image = [_texPath + "Image\Struct\Roof.jpg",_texPath + "Image\Struct\Roof.jpg"];
structDefs set [_type, [
	"Roof High", _price, siBoth, _image, true, false, 30, 1, 20, _objects, _objects,
	[localize {TZK_SERVER_INIT_STRUCT_SEC}], []]
];
structMarker set [_type, ""];
_roofHigh = _type;
...
structDefs set [_type, [
	...
	[localize {TZK_SERVER_INIT_STRUCT_SEC}],
	["\TZK_Scripts_4_0_5\Common\InitAmmocrate.sqs"]]
];
structMarker set [_type, ""];
stAmmoCrate = _type;
_type = _type + 1;
