...
structDefs set [_type, ["Light Vehicle Factory", _price, siBoth, _image, true, true, 2, 10, 20, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitPrimaryStructure.sqs", "Server\BuyUnit\Factory.sqs"], ["Player\Init\LightVehicleFactory.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Barracks", _price, siBoth, _image, true, true, 2, 10, 20, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitPrimaryStructure.sqs", "Server\BuyUnit\Factory.sqs"], ["Player\Init\Barracks.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Heavy Vehicle Factory", _price, siBoth, _image, true, true, 2, 10, 20, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitPrimaryStructure.sqs", "Server\BuyUnit\Factory.sqs"], ["Player\Init\HeavyVehicleFactory.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Aircraft Factory", _price, siBoth, _image, true, true, 2, 20, 35, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitPrimaryStructure.sqs", "Server\BuyUnit\Factory.sqs"], ["Player\Init\AircraftFactory.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Shipyard", _price, siBoth, _image, false, false, 2, 10, 20, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitPrimaryStructure.sqs", "Server\BuyUnit\Factory.sqs"], ["Player\Init\ShipyardFactory.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
