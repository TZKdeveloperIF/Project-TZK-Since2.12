...
structDefs set [_type, ["Air Radar - 4000m range", _price, siBoth, _image, false, false, 10, 5, 15, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
_objects = [["StromHaus1_xj400", 270, []]];
_image = [_texPath + "Image\Struct\maptower.jpg", _texPath + "Image\Struct\maptower.jpg"];
structDefs set [_type, ["Map Marker Tower", _price, siBoth, _image, false, false, 4, 5, 15, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mRadar];
stradar = _type;
_type = _type + 1;
...
structDefs set [_type, ["Unit Camera Tower", _price, siBoth, _image, false, false, 4, 5, 15, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mRadar];
stSatRec = _type;
_type = _type + 1;
...
structDefs set [_type, ["Light Vehicle Factory", _price, siBoth, _image, true, true, 2, 10, 20, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}, "Server\BuyUnit\Factory.sqs"], ["Player\Init\LightVehicleFactory.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Command Center", _price, siBoth, _image, true, true, 2, 5, 20, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Barracks", _price, siBoth, _image, true, true, 2, 10, 20, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}, "Server\BuyUnit\Factory.sqs"], ["Player\Init\Barracks.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Heavy Vehicle Factory", _price, siBoth, _image, true, true, 2, 10, 20, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}, "Server\BuyUnit\Factory.sqs"], ["Player\Init\HeavyVehicleFactory.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Aircraft Factory", _price, siBoth, _image, true, true, 2, 20, 35, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}, "Server\BuyUnit\Factory.sqs"], ["Player\Init\AircraftFactory.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Shipyard", _price, siBoth, _image, false, false, 2, 10, 20, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}, "Server\BuyUnit\Factory.sqs"], ["Player\Init\ShipyardFactory.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Field Hospital", _price, -1, _image, false, false, 10, 4, 15, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_PRIM}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]] ];
...
structDefs set [_type, ["Fuel Station", _price, siBoth, _image, false, false, 5, 10, 20, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC},  "\TZK_Scripts_4_0_4\Server\InitFuelStation.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["MG Fort", _price, siBoth, _image, false, false, 20, 2, 15, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["MG Tower", _price, siBoth, _image, false, false, 20, 2, 10, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
_mgTowerWood = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm", _price, siBoth, _image, false, false, 25, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
_mg = _type;
_type = _type + 1;
...
structDefs set [_type, ["Static MG 12.7mm", _price, siBoth, _image, false, false, 25, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]] ];
structMarker set [_type, _mMG];
_staticMG = _type;
_type = _type + 1;
...
_image = ["Extra\ppl\MG.jpg","Extra\ppl\MG.jpg"];
structDefs set [_type, ["Static GL", _price, siBoth, _image, false, false, 25, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]] ];
structMarker set [_type, _mMG];
_staticGL = _type;
_type = _type + 1;
...
structDefs set [_type, ["Static AT-Launcher", _price, siBoth, _image, false, false, 25, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]] ];
structMarker set [_type, _mMG];
_staticAT = _type;
_type = _type + 1;
...
structDefs set [_type, ["Gunfort", _price, siBoth, _image, false, false, 15, 2, 25, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["Wall", _price, siBoth, _image, false, false, 75, 0.5, 15, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], []]  ];
structMarker set [_type, ""];
_wall = _type;
...
structDefs set [_type, ["Wall Low", _price, siBoth, _image, false, false, 75, 0.5, 15, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], []]  ];
structMarker set [_type, ""];
_walls = _type;
alignTypes set [count alignTypes, _type]; alignDefs set [ count alignDefs, [[0,0], 9.9] ];
_type = _type + 1;
...
structDefs set [_type, ["Roof", _price, siBoth, _image, true, false, 30, 1, 20, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], []]  ];
structMarker set [_type, ""];
_roof = _type;
_type = _type + 1;
...
_image = [_texPath + "Image\Struct\Roof.jpg",_texPath + "Image\Struct\Roof.jpg"];
structDefs set [_type, ["Roof High", _price, siBoth, _image, true, false, 30, 1, 20, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], []]  ];
structMarker set [_type, ""];
_roofHigh = _type;
_type = _type + 1;
...
structDefs set [_type, ["Tank Trench", _price, siBoth, _image, true, false, 50, 5, 20, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], []]  ];
structMarker set [_type, ""];
_tanktr = _type;
...
_image = [_texPath + "Image\Struct\Roof.jpg",_texPath + "Image\Struct\Roof.jpg"];
structDefs set [_type, ["Artillery Plain", _price, siBoth, _image, true, false, 12, 15, 15, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], []]  ];
structMarker set [_type, ""];
_artPlain = _type;
_type = _type + 1;
...
structDefs set [_type, ["Sand Bags", _price, siBoth, _image, false, false, 100, 1, 10, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], []]  ];
structMarker set [_type, ""];
_sandbag = _type;
...
structDefs set [_type, ["Tank Trap", _price, siBoth, _image, false, false, 100, 1, 10, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], []]  ];
structMarker set [_type, ""];
_tankt = _type;
...
//structDefs set [_type, ["Wire fence", _price, siBoth, _image, false, true, 100, 2, 10, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], []]  ];
structMarker set [_type, ""];
...
structDefs set [_type, ["Heli H", _price, siBoth, _image, false, false, 20, 5, 15, _objects, _objects, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
