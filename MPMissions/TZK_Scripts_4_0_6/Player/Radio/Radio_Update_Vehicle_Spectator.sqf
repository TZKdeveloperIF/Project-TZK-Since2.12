...
Radio009 setTriggerText "Marker Displaying Switch"; Radio009 setTriggerStatements ["this", {btnMarker = !btnMarker; if !btnMarker then {call preprocessFile localize {TZK_FUNC_MARKER_HIDE_SPEC}} else {[boole_Mark_Player_Name] exec localize {TZK_MARKER_SPEC}}}, ""];
