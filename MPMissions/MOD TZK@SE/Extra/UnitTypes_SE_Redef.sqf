...
{_entry = unitDefs select _x; _entry set [udModel, "DVDUS_SoldierWSMAW"]} forEach [_soldierLAWW, _soldierLAWW1];
{_entry = unitDefs select _x; _entry set [udModel, "DVDUS_SoldierWSMAW2"]} forEach [_soldierATW, _soldierATW1];
...
{_entry = unitDefs select _x; _entry set [udModel, "icp_infRPG18"]} forEach [_soldierLAWE, _soldierLAWE1];
{_entry = unitDefs select _x; _entry set [udModel, "icp_infAT2"]} forEach [_soldierATE, _soldierATE1];
...
_entry = unitDefs select _brdmE; _entry set [udModel, "MNF_BRDM2U"];
_entry = unitDefs select _brdmE3; _entry set [udCost, [1100, 2200] select PricingMode]; _entry set [udName, "BRDM2 Rockets"]; _entry set [udModel, "MNF_BRDM2_AT3"];
...
_entry = unitDefs select _tunguskaE;  _entry set [udName, "4xAA"]; _entry set [udModel, "RUS_ZSU"]; _entry select udScripts set [0, "Common\Equip\DefAA.sqs"];
...
_entry = unitDefs select _irNO_mi17; _entry set [udName, "Mi17 (Tug)"]; _entry set [udCost, [3000, 6000] select PricingMode];
...
_entry = unitDefs select _t90Etown; _entry set [udModel, "T90"];
