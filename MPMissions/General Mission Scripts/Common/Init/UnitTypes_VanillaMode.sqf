...
if bool_TZK_199_Mode Then {call loadFile "Common\Init\UnitTypes_ACWA_Redefine.sqf"};


unitDefs select _m60W set [udCost, (unitDefs select _m60W select udCost)/2];
...
unitDefs select _t72E set [udCost, (unitDefs select _t72E select udCost)*3/4];
...
if false Then {call loadFile "Common\Init\UnitTypes_MFCTI116_TZK_Units.sqf"};
if bool_TZK_199_Mode Then {call loadFile "Common\Init\UnitTypes_MFCTI116_Units.sqf"};