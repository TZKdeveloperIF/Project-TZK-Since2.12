...
Radio003 setTriggerText "Switch 080m/s Magazine"; call format [{ Radio003 setTriggerStatements ["this", {[(vehicle player), 080, "%1"] exec "Player\Radio\Graduation.sqs"}, ""] }, _name];
Radio004 setTriggerText "Switch 120m/s Magazine"; call format [{ Radio004 setTriggerStatements ["this", {[(vehicle player), 120, "%1"] exec "Player\Radio\Graduation.sqs"}, ""] }, _name];
