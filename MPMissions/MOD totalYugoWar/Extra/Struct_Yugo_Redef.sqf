...
structDefs set [_type, ["Fuel Station", _price, siBoth, _image, false, false, 5, 10, 20, _objects, _objects, [(TzkScripts select 217),  "\TZK_Patch4_4_0_6\s\Server\InitFuelStation.sqs"], [(TzkScripts select 162)]]  ];
...
structDefs set [_type, ["Mortar 81 mm", _price, siBoth, _image, false, false, 6, 2, 10, _objects0, _objects1, [(TzkScripts select 215)], [(TzkScripts select 193), (TzkScripts select 162)]]  ];
...
structDefs set [_type, ["MG 12.7mm", 300, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
...
structDefs set [_type, ["MG 12.7mm Fort", 500, siBoth, _image, false, false, 10, 2, 10, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
structMarker set [_type, _mMG];
_mgFort = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm Pillbox", 500, siBoth, _image, false, false, 10, 2, 10, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
structMarker set [_type, _mMG];
_mgPillbox = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm Tower Wood", 600, siBoth, _image, false, false, 10, 2, 10, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
structMarker set [_type, _mMG];
_mgTowerWood = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm Tower Concrete", 600, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
structMarker set [_type, _mMG];
...
structDefs set [_type, ["BumbleBee ATGM(no rearm!)", 800, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
...
structDefs set [_type, ["KonkursM ATGM", 800, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
structMarker set [_type, _mHowitzer];
_KONK = _type;
_type = _type + 1;
...
structDefs set [_type, ["M46 Field Gun", 800, siBoth, _image, false, false, 10, 2, 7, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
structMarker set [_type, _mHowitzer];
_M46 = _type;
_type = _type + 1;
...
structDefs set [_type, ["100mm Gun Fort", 800, siBoth, _image, false, false, 10, 2, 7, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
structMarker set [_type, _mHowitzer];
_GunFort = _type;
_type = _type + 1;
...
structDefs set [_type, ["AAGuns 23mmx2", 600, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
...
structDefs set [_type, ["AAGuns 23mmx2+AAML", 1000, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [(TzkScripts select 217)], [(TzkScripts select 162)]]  ];
structMarker set [_type, _mg];
_AAM = _type;
_type = _type + 1;
...
structDefs set [_type, ["Dugin Pos", 200, siBoth, _image, false, false, 10, 2, 6, _objects, _objects, [(TzkScripts select 217)], []] ];
...
structDefs set [_type, ["Foxhole", 200, siBoth, _image, false, false, 10, 2, 6, _objects, _objects, [(TzkScripts select 217)], []] ];
structMarker set [_type, ""];
_foxHole = _type;
_type = _type + 1;
...
structDefs set [_type, ["Wall High", 200, siBoth, _image, false, false, 50, 0.5, 10, _objects, _objects, [(TzkScripts select 217)], []] ];
structMarker set [_type, ""];
_wall = _type;
...
structDefs set [_type, ["Wall Low", 100, siBoth, _image, false, false, 50, 0.5, 10, _objects, _objects, [(TzkScripts select 217)], []] ];
structMarker set [_type, ""];
_walls = _type;
alignTypes set [count alignTypes, _type]; alignDefs set [ count alignDefs, [[0,0], 9.9] ];
_type = _type + 1;
...
structDefs set [_type, ["Roof", 500, siBoth, _image, false, false, 10, 1, 10, _objects, _objects, [(TzkScripts select 217)], []] ];
structMarker set [_type, ""];
_roof = _type;
_type = _type + 1;
...
structDefs set [_type, ["Tank Trench", 600, siBoth, _image, false, false, 50, 5, 10, _objects, _objects, [(TzkScripts select 217)], []] ];
structMarker set [_type, ""];
_tanktr = _type;
_type = _type + 1;
...
structDefs set [_type, ["CAMO Net full", 300, siBoth, _image, false, false, 10, 2, 10, _objects, _objects, [(TzkScripts select 217)], []] ];
structMarker set [_type, ""];
_netFull = _type;
_type = _type + 1;
...
structDefs set [_type, ["CAMO Net roof", 300, siBoth, _image, false, false, 10, 2, 15, _objects, _objects, [(TzkScripts select 217)], []] ];
structMarker set [_type, ""];
_netRoof = _type;
_type = _type + 1;
...
structDefs set [_type, ["CAMO Net tent", 300, siBoth, _image, false, false, 10, 2, 10, _objects, _objects, [(TzkScripts select 217)], []] ];
...
structDefs set [_type, ["Heli H", 100, siBoth, _image, false, false, 10, 5, 15, _objects, _objects, [(TzkScripts select 217)], []] ];
