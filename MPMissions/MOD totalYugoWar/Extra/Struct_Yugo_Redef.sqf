...
structDefs set [_type, ["MG 12.7mm", 300, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["MG 12.7mm Fort", 500, siBoth, _image, false, false, 10, 2, 10, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
_mgFort = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm Pillbox", 500, siBoth, _image, false, false, 10, 2, 10, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
_mgPillbox = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm Tower Wood", 600, siBoth, _image, false, false, 10, 2, 10, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
_mgTowerWood = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm Tower Concrete", 600, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
...
structDefs set [_type, ["BumbleBee ATGM(no rearm!)", 800, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["KonkursM ATGM", 800, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mHowitzer];
_KONK = _type;
_type = _type + 1;
...
structDefs set [_type, ["M46 Field Gun", 800, siBoth, _image, false, false, 10, 2, 7, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mHowitzer];
_M46 = _type;
_type = _type + 1;
...
structDefs set [_type, ["100mm Gun Fort", 800, siBoth, _image, false, false, 10, 2, 7, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mHowitzer];
_GunFort = _type;
_type = _type + 1;
...
structDefs set [_type, ["AAGuns 23mmx2", 600, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["AAGuns 23mmx2+AAML", 1000, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, [localize {TZK_SERVER_INIT_STRUCT_SEC}], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mg];
_AAM = _type;
_type = _type + 1;
