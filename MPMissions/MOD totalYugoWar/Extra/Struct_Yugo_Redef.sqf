...
structDefs set [_type, ["Mortar 60mm", _price, siBoth, _image, false, false, 6, 2, 10, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitStructureDefenceTower.sqs"], ["\TZK_Scripts_4_0_4\Player\InitStructureEventHandler.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
_objects1 = [["M252Mortar_TZK_E_xj400", 0, [0,5,0.1]]];
_image = ["\TZK_Objects\Texture\icon\iM252.paa","\TZK_Objects\Texture\icon\iM252.paa"];
structDefs set [_type, ["Mortar (Non-Artillery)", _price, siBoth, _image, false, false, 6, 2, 10, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitStructureDefenceTower.sqs"], ["\TZK_Scripts_4_0_4\Player\InitStructureEventHandler.sqs", "\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMortar];
_mortar_ArtNO = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm", 300, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["MG 12.7mm Fort", 500, siBoth, _image, false, false, 10, 2, 10, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
_mgFort = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm Pillbox", 500, siBoth, _image, false, false, 10, 2, 10, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
_mgPillbox = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm Tower Wood", 600, siBoth, _image, false, false, 10, 2, 10, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
_mgTowerWood = _type;
_type = _type + 1;
...
structDefs set [_type, ["MG 12.7mm Tower Concrete", 600, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mMG];
...
structDefs set [_type, ["BumbleBee ATGM(no rearm!)", 800, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["KonkursM ATGM", 800, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mHowitzer];
_KONK = _type;
_type = _type + 1;
...
structDefs set [_type, ["M46 Field Gun", 800, siBoth, _image, false, false, 10, 2, 7, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mHowitzer];
_M46 = _type;
_type = _type + 1;
...
structDefs set [_type, ["100mm Gun Fort", 800, siBoth, _image, false, false, 10, 2, 7, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mHowitzer];
_GunFort = _type;
_type = _type + 1;
...
structDefs set [_type, ["AAGuns 23mmx2", 600, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
...
structDefs set [_type, ["AAGuns 23mmx2+AAML", 1000, siBoth, _image, false, false, 10, 2, 5, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Player\Marker\InitStructureMarker.sqs"]]  ];
structMarker set [_type, _mg];
_AAM = _type;
_type = _type + 1;
...
structDefs set [_type, ["Dugin Pos", 200, siBoth, _image, false, false, 10, 2, 6, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
...
structDefs set [_type, ["Foxhole", 200, siBoth, _image, false, false, 10, 2, 6, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
structMarker set [_type, ""];
_foxHole = _type;
_type = _type + 1;
...
structDefs set [_type, ["Wall High", 200, siBoth, _image, false, false, 50, 0.5, 10, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
structMarker set [_type, ""];
_wall = _type;
...
structDefs set [_type, ["Wall Low", 100, siBoth, _image, false, false, 50, 0.5, 10, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
structMarker set [_type, ""];
_walls = _type;
alignTypes set [count alignTypes, _type]; alignDefs set [ count alignDefs, [[0,0], 9.9] ];
_type = _type + 1;
...
structDefs set [_type, ["Roof", 500, siBoth, _image, false, false, 10, 1, 10, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
structMarker set [_type, ""];
_roof = _type;
_type = _type + 1;
...
structDefs set [_type, ["Tank Trench", 600, siBoth, _image, false, false, 50, 5, 10, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
structMarker set [_type, ""];
_tanktr = _type;
_type = _type + 1;
...
structDefs set [_type, ["CAMO Net full", 300, siBoth, _image, false, false, 10, 2, 10, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
structMarker set [_type, ""];
_netFull = _type;
_type = _type + 1;
...
structDefs set [_type, ["CAMO Net roof", 300, siBoth, _image, false, false, 10, 2, 15, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
structMarker set [_type, ""];
_netRoof = _type;
_type = _type + 1;
...
structDefs set [_type, ["CAMO Net tent", 300, siBoth, _image, false, false, 10, 2, 10, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
...
structDefs set [_type, ["Ammo Crate", _price, siBoth, _image, false, false, 10, 5, 8, _objects0, _objects1, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], ["\TZK_Scripts_4_0_4\Common\InitAmmocrate.sqs"]]  ];
structMarker set [_type, ""];
stAmmoCrate = _type;
_type = _type + 1;
_objects = [["heliH", 0, []]];
_image = ["\TotalYugoWarFinal\Images\HeliH.jpg","\TotalYugoWarFinal\Images\HeliH.jpg"];
structDefs set [_type, ["Heli H", 100, siBoth, _image, false, false, 10, 5, 15, _objects, _objects, ["\TZK_Scripts_4_0_4\Server\InitSecondaryStructure.sqs"], []] ];
