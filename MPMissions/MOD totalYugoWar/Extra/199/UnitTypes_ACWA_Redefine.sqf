...
{_str = "Jeep_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_jeepW, jeepaW];
{_str = "HMMWV_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_hummerW];
{_str = "Truck5t_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_truckW];
{_str = "Truck5tRepair_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_supportTruckW, _supportTruckW2];
{_str = "Truck5tRefuel", unitDefs select _x set [udModel, _str]} forEach [_truckRefuelW];
{_str = "M113Ambul_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_supportAPCW, _supportAPCWminer];
{_str = "M113_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_m113W];
{_str = "M2A2_AA_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_m2a2W, _m3a2W, _m2a2d, _m2a2at, _m2a2aa];
{_str = "M2A2_AA_Town_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_m2a2townat, _m2a2townaad];
{_str = "MCVW_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [utMCVW];
{_str = "MHQW_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [utMHQ0];

{_str = "UAZ_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_uazE, uazaE];
{_str = "BRDM_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_brdmE];
{_str = "Ural_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_truckE];
{_str = "UralRepair_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_supportTruckE, _supportTruckE2];
{_str = "UralRefuel", unitDefs select _x set [udModel, _str]} forEach [_truckRefuelE];
{_str = "BMPAmbul_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_supportAPCE, _supportAPCEminer];
{_str = "M113_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_bmpE];
{_str = "BMP2_AA_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_bmp2E, _bmp2_EE, _bmp2d, _bmp2at, _bmp2Cannon, _bmp2aa];
{_str = "BMP2_AA_Town_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_bmp2townat, _bmp2townaad];
{_str = "MCVE_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [utMCVE];
{_str = "MHQE_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [utMHQ1];

{_str = "A10_AAOnly_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_a10gun];
{_str = "A10_LGB_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_a10LGB4, _a10LGB8];
{_str = "A10_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_a10bombs, _a10, _a10AA];
{_str = "A10_FFAR_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_a10FFAR];
{_str = "A10_Buster_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_a10BB];
{_str = "A10_Tomahawk_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_a10Tomahawk];
{_str = "Su25_AAOnly_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_su25gun];
{_str = "Su25_LGB_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_su25LGB4, _su25LGB8];
{_str = "Su25_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_su25bombs, _su25, _su25AA];
{_str = "Su25_Rocket_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_su25Rocket];
{_str = "Su25_Buster_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_su25BB];
{_str = "Su25_Raduga_Vanilla_xj405", unitDefs select _x set [udModel, _str]} forEach [_su25Raduga];