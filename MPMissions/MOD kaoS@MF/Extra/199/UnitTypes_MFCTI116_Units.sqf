...
_entry = unitDefs select _m60W; _entry set [udModel, "MFCTI116M60"]; _entry set [udName, "M60"]; _entry set [udCost, 1000]; _entry set [udBuildTime, 40];
_entry = unitDefs select _m60A3W; _entry set [udModel, "MFCTI116M60A3"]; _entry set [udName, "M60A3"]; _entry set [udCost, 1400]; _entry set [udBuildTime, 40]; _entry set [udFactoryType, 2^stHeavy];
_entry = unitDefs select _m1a1W; _entry set [udModel, "MFCTI116M1"]; _entry set [udName, "M1"]; _entry set [udCost, 3000]; _entry set [udBuildTime, 50];
_entry = unitDefs select _m1a2sepW; _entry set [udModel, "MFCTI116M1A1"]; _entry set [udName, "M1A1"]; _entry set [udCost, 4000]; _entry set [udBuildTime, 50]; _entry set [udImage, "iabrams"]; _entry set [udFactoryType, 2^stHeavy];
...
_entry = unitDefs select _t72E; _entry set [udModel, "MFCTI116T72"]; _entry set [udName, "T72"]; _entry set [udCost, 1700]; _entry set [udBuildTime, 40];
_entry = unitDefs select _t72_AE; _entry set [udModel, "MFCTI116T72A"]; _entry set [udName, "T72A"]; _entry set [udCost, 1900]; _entry set [udBuildTime, 40]; _entry set [udFactoryType, 2^stHeavy];
_entry = unitDefs select _t72_BE; _entry set [udModel, "MFCTI116T72B"]; _entry set [udName, "T72B"]; _entry set [udCost, 2200]; _entry set [udBuildTime, 40]; _entry set [udFactoryType, 2^stHeavy];
