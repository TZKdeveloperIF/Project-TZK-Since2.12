...
{_str = "HeavyGrenadier_xj400", unitDefs select _x set [udModel, _str]} forEach [_6G30E];
...
{_str = "SoldierESaboteurBizon_xj400", unitDefs select _x set [udModel, _str]} forEach [_bomberE, _customE];
