if not _found then {if ("M" == _firstChar) then {
	if not _found then {if ("M1A1_xj400" countType [_vehicle] > 0) then {
...
if not _found then {if ("T" == _firstChar) then {
	if not _found then {if (("T80_xj400" countType [_vehicle] > 0 || "T80Res_TZK_xj400" countType [_vehicle] > 0)) then {
	...
	if not _found then {if ("Leo2A6_xj400" countType [_vehicle] > 0) then {
	...
	if not _found then {if ("ZTZ99_xj400" countType [_vehicle] > 0) then {
