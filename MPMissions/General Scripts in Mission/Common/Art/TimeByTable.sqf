private [{_h}, {_v}, {_d}, {_bHigh}, {_posV}, {_posT}, {_ret}];
...
if (_valid) then {
	...
	_d2 = _d1 + 10;
	_lambda = {format [
		"\TZK_Art_Time_4_0_6\data\s+%1_h%2%3_%4.sqf",
		_this select 0,
