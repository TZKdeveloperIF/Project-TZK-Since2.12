private ["_vx", "_vy", "_yS", "_xE"];
private ["_c", "_g", "_h", "_t", "_x", "_y", "_retType"]; 
private ["_vx0", "_vy0",  "_K1", "_L1", "_K2", "_L2", "_K3", "_L3", "_K4", "_L4"];

_vx = _this select 0; _vy = _this select 1; _yS = _this select 2; _xE = _this select 3;

_g = 9.80665; _h = 0.05; _c = -0.0005;
_x = 0;	_y = _yS;		_retType = 0;
...
_t = (_x-_xE)/(_vx0+_vx); _y = _y - _t*(_vy0+_vy);
[_y, _vy]