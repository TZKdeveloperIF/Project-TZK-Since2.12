...
Radio003 setTriggerText "Switch 080m/s Magazine"; call format [{ Radio003 setTriggerStatements ["this", {[(vehicle player), 080, "%1"] exec (TzkScripts select 199)}, ""] }, _name];
Radio004 setTriggerText "Switch 120m/s Magazine"; call format [{ Radio004 setTriggerStatements ["this", {[(vehicle player), 120, "%1"] exec (TzkScripts select 199)}, ""] }, _name];
Radio005 setTriggerText "Switch 180m/s Magazine"; call format [{ Radio005 setTriggerStatements ["this", {[(vehicle player), 180, "%1"] exec (TzkScripts select 199)}, ""] }, _name];
