// args: [NetworkIDs: array, param: any, script: string]

private [{_netIds},{_param},{_script}, {_i},{_j},{_k},{_c},{_unit},{_idx},{_found},{_bNewObj}];
_netIds = _this select 0; _param = _this select 1; _script = _this select 2;
// update ID and time
...
while {_i < _c} do {
	...
	[_unit, _param, TzkRtsObjPool select _idx, TzkRtsSvrId] exec _script;
	_i = _i + 1;
};
