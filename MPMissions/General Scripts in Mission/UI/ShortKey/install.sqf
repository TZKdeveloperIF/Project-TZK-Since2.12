...
// One list dialog
	_planIdx = _planIdx + 1;
	TzkShortkeyDesignArray set [_planIdx, []];
	TzkShortkeyNameArray set [_planIdx, "dlg_one_list"];
	...
	[_design, "8", "item 8", _i] call _initItem; _i = _i + 1;
	[_design, "9", "item 9", _i] call _initItem; _i = _i + 1;
	[_design, "0", "item 10", _i] call _initItem; _i = _i + 1;
...
// Confirm only
	_planIdx = _planIdx + 1;
	TzkShortkeyDesignArray set [_planIdx, []];
	TzkShortkeyNameArray set [_planIdx, "dlg_confirm_only"];
...
// Generic dialog
	_planIdx = _planIdx + 1;
	TzkShortkeyDesignArray set [_planIdx, []];
	TzkShortkeyNameArray set [_planIdx, "dlg_generic"];

	_design = TzkShortkeyDesignArray select _planIdx;
	[_design, -1] call _initDesign; _i = 0;

	[_design, "Space", "confirm", _i] call _initItem; _i = _i + 1;

	[_design, "F1", "button 1", _i] call _initItem; _i = _i + 1;
	[_design, "F2", "button 2", _i] call _initItem; _i = _i + 1;
	[_design, "F3", "button 3", _i] call _initItem; _i = _i + 1;
	[_design, "F4", "button 4", _i] call _initItem; _i = _i + 1;
	[_design, "F5", "button 5", _i] call _initItem; _i = _i + 1;
